...
class PantallaResumen(QWidget):
    def __init__(self, parent=None):
        ...
        titulo_pantalla.setFont(QFont("Arial", 18))
    ...
    def crear_tarjeta_pregunta(self, numero, titulo):
        ...
        lbl_nivel.setFont(QFont("Arial", 12))
        ...
        lbl_respuesta = QLabel("Respuesta: El interno indica que no tiene planes inmediatos...")
        lbl_respuesta.setFont(QFont("Arial", 12))
        lbl_respuesta.setWordWrap(True) # Permite que el texto salte de línea si es muy largo
        tarjeta_layout.addWidget(lbl_respuesta)

        lbl_analisis = QLabel("Análisis IA: Pendiente de procesamiento.")
        lbl_analisis.setFont(QFont("Arial", 12))
        ...
        self.boton_entrar.setIconSize(QSize(35, 35))
